...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksWithConditionsReturnList() {
        ...
        Book book3 = new Book("Secrets life of programmers", "Steve Wolkowitz", 2016);
    ...
    public void testListBooksInHandsOf() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Name1","Lastname1","99010211123");
        List<Book> borrowedBooks = generateListOfNBooks(0);
        ...
        //Then
        Assert.assertEquals(0,actualListOfBorrowedBooks.size());
    ...
    public void testListBooksInHandsOf1() {
        ...
        List<Book> actualListOfBorrowedBooks = bookLibrary.listBooksInHandsOf(libraryUser);
        //Then
        Assert.assertEquals(1,actualListOfBorrowedBooks.size());
    ...
    public void testListBooksInHandsOfMoreThan5() {
        ...
        List<Book> actualListOfBorrowedBooks = bookLibrary.listBooksInHandsOf(libraryUser);
        //Then
        Assert.assertEquals(5,actualListOfBorrowedBooks.size());
